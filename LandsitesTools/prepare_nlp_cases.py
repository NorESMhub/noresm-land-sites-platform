...
"in a settings.txt file or interactive command line input."
...
################################################################################
    ...
    def_settings = InterfaceSettings(Path(__file__).absolute().parent.parent / \
    "settings.txt")
    ### Load case DataFrame
    ...
    try:
        cust_settings_dir = def_settings.platform_dir / "custom_settings"
