...
#AVAILABLEYEARS=(0003 0004 0005 0006 0007 0008 0009 0010 0011 0012)
...
ARRAY=("area&GRIDAREA&m2&S"
   ...
   "od870csaer&CDOD870/(CLDFREE+1.e-4f)&1&C"
	...
	"wetso4&-1.0f*$SF1*(SO4_ACSFWET+SO4_A1SFWET+${SF2}/${SF1}*SO4_A2SFWET+SO4_PRSFWET+SO4_NASFWET+SO4_ACSFWET+SO4_A1_OCWSFWET+${SF2}/${SF1}*SO4_A2_OCWSFWET+SO4_PR_OCWSFWET+SO4_NA_OCWSFWET)&kg m-2 s-1&S"
